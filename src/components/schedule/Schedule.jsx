    ...
    <>
      <div className="w-full mt-[60px] max-[480px]:mt-[40px]">
        <div className="flex items-center justify-between max-[570px]:flex-col max-[570px]:items-start max-[570px]:gap-y-2">
          <div className="font-bold text-2xl text-[#3324f2] max-[478px]:text-[18px]">
            Estimated Schedule
          </div>
        ...
        <div className="flex flex-col mt-5 items-start">
            ...
            (item, idx) => (
              ...
              >
                <div className="flex items-center max-w-[500px] gap-x-7 max-[400px]:gap-x-2">
                  <div
                    className="text-lg font-semibold text-[#ffffff59] group-hover:text-[#3324f2] transition-all duration-300 ease-in-out max-[600px]:text-[14px]
                  max-[275px]:text-[12px]"
                  >
                    {item.time || "N/A"}
                  </div>
                  <h3
                    className="text-[17px] font-semibold line-clamp-1 group-hover:text-[#3324f2] transition-all duration-300 ease-in-out max-[600px]:text-[14px]
                  max-[275px]:text-[12px]"
                  >
                    {item.title || "N/A"}
                  </h3>
                </div>
                <button className="max-w-[150px] flex items-center py-1 px-4 rounded-lg gap-x-2 group-hover:bg-[#3324f2] transition-all duration-300 ease-in-out">
                  <FontAwesomeIcon
                    icon={faPlay}
          ...
          {scheduleData.length > 7 && (
            <button
              ...
              className="text-white py-4 hover:text-[#3324f2] font-semibold transition-all duration-300 ease-in-out max-sm:text-[13px]"
            >
