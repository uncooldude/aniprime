  ...
  return (
    <div className={`flex flex-col space-y-6 ${className}`}>
      <div className="flex justify-between items-center max-[350px]:flex-col max-[350px]:gap-y-2 max-[350px]:items-start">
        <h1 className="font-bold text-2xl text-[#3324f2]">Top 10</h1>
        <ul className="flex justify-between w-fit bg-[#373646] rounded-[4px] text-sm font-bold">
          <li
            className={`cursor-pointer p-2 px-3 ${
              activePeriod === "today"
                ? "bg-[#3324f2] text-[#555462] rounded-l-[4px]"
                : "text-white"
            } ${activePeriod !== "today" ? "hover:text-[#3324f2]" : ""}`}
          ...
          <li
            className={`cursor-pointer p-2 px-3 ${
              activePeriod === "week"
                ? "bg-[#3324f2] text-[#555462]"
                : "text-white"
            } ${activePeriod !== "week" ? "hover:text-[#3324f2]" : ""}`}
          ...
          <li
            className={`cursor-pointer p-2 px-3 ${
              activePeriod === "month"
                ? "bg-[#3324f2] text-[#555462] rounded-r-[4px]"
                : "text-white"
            } ${activePeriod !== "month" ? "hover:text-[#3324f2]" : ""}`}
            ...
            >
              <h1
                className={`font-bold text-2xl  ${
                  index + 1 < 4
                    ? "pb-1 text-white border-b-[3px] border-[#3324f2]"
                    : "text-[#777682]"
                } max-[350px]:hidden`}
              >
