    ...
    return (
        <div className="bg-[#201F31] w-full h-screen flex justify-center items-center">
            <div className="flex flex-col w-fit h-fit items-center justify-center">
                ...
                <button className="bg-[#3324f2] py-2 px-4 w-fit rounded-3xl text-black text-light flex items-center gap-x-2 mt-7">
                    <FaChevronLeft className="text-[#3324f2] w-[20px] h-[20px] rounded-full p-1 bg-black" />
