  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="bg-white w-[30px] h-[30px] p-2 rounded-full text-3xl absolute z-[1000] top-[-14px] right-[-14px] hover:text-[#3324f2] cursor-pointer transform transition-all ease-in-out duration-300 flex items-center justify-center hover:bg-[#3324f2] max-md:top-0 max-md:right-0 max-md:rounded-none max-md:rounded-bl-lg max-md:rounded-tr-lg"
          onClick={onClose}
        >
