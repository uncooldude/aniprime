      ...
      >
        <div className="flex gap-x-6 items-center w-fit max-lg:w-full max-lg:justify-between">
          <div className="flex gap-x-6 items-center w-fit">
            ...
            >
              {logoTitle.slice(0, 3)}
              <span className="text-[#3324f2]">{logoTitle.slice(3, 4)}</span>
              {logoTitle.slice(4)}
            </Link>
          </div>
          <WebSearch />
        ...
        <div className="flex gap-x-7 items-center max-lg:hidden">
          {[
            ...
            >
              <FontAwesomeIcon
                icon={item.icon}
                className="text-[#3324f2] text-xl font-bold"
              />
            ...
            <div className="flex">
              {["EN", "JP"].map((lang, index) => (
                <button
                  ...
                  className={`px-1 py-[1px] text-xs font-bold ${index === 0 ? "rounded-l-[3px]" : "rounded-r-[3px]"} ${language === lang ? "bg-[#3324f2] text-black" : "bg-gray-600 text-white"}`}
                >
                  {lang}
                </button>
              ))}
